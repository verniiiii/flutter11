...
// Core Models
import 'package:flutter11/core/models/transaction_model.dart';

// Data Sources
import 'package:flutter11/data/datasources/transaction_local_datasource.dart';
import 'package:flutter11/data/datasources/auth_local_datasource.dart';
import 'package:flutter11/data/datasources/card_local_datasource.dart';
import 'package:flutter11/data/datasources/news_local_datasource.dart';
import 'package:flutter11/data/datasources/motivation_local_datasource.dart';
import 'package:flutter11/data/datasources/social_local_datasource.dart';

// Repositories
import 'package:flutter11/data/repositories/transaction_repository_impl.dart';
import 'package:flutter11/data/repositories/auth_repository_impl.dart';
import 'package:flutter11/data/repositories/card_repository_impl.dart';
import 'package:flutter11/data/repositories/news_repository_impl.dart';
import 'package:flutter11/data/repositories/motivation_repository_impl.dart';
import 'package:flutter11/data/repositories/social_repository_impl.dart';

// Domain Repositories (interfaces)
import 'package:flutter11/domain/repositories/transaction_repository.dart';
import 'package:flutter11/domain/repositories/auth_repository.dart';
import 'package:flutter11/domain/repositories/card_repository.dart';
import 'package:flutter11/domain/repositories/news_repository.dart';
import 'package:flutter11/domain/repositories/motivation_repository.dart';
import 'package:flutter11/domain/repositories/social_repository.dart';

// Use Cases
import 'package:flutter11/domain/usecases/transactions/get_transactions_usecase.dart';
import 'package:flutter11/domain/usecases/transactions/add_transaction_usecase.dart';
import 'package:flutter11/domain/usecases/transactions/update_transaction_usecase.dart';
import 'package:flutter11/domain/usecases/transactions/delete_transaction_usecase.dart';
import 'package:flutter11/domain/usecases/transactions/get_transactions_by_type_usecase.dart';
import 'package:flutter11/domain/usecases/auth/login_usecase.dart';
import 'package:flutter11/domain/usecases/auth/register_usecase.dart';
import 'package:flutter11/domain/usecases/auth/logout_usecase.dart';
import 'package:flutter11/domain/usecases/auth/get_current_user_usecase.dart';
import 'package:flutter11/domain/usecases/cards/get_cards_usecase.dart';
import 'package:flutter11/domain/usecases/cards/add_card_usecase.dart';
import 'package:flutter11/domain/usecases/cards/delete_card_usecase.dart';
import 'package:flutter11/domain/usecases/news/get_news_usecase.dart';
import 'package:flutter11/domain/usecases/news/get_currency_rates_usecase.dart';
import 'package:flutter11/domain/usecases/motivation/get_random_motivation_usecase.dart';
import 'package:flutter11/domain/usecases/social/get_friends_usecase.dart';

// Presentation Stores
import 'package:flutter11/ui/features/transactions/state/transaction_form_store.dart';
import 'package:flutter11/ui/features/transactions/state/edit_transaction_store.dart';
import 'package:flutter11/ui/features/transactions/state/statistics_store.dart';
import 'package:flutter11/ui/features/transactions/state/transaction_details_store.dart';
import 'package:flutter11/ui/features/onboarding/state/onboarding_store.dart';
import 'package:flutter11/ui/features/auth/state/auth_store.dart';
import 'package:flutter11/ui/features/cards/state/cards_store.dart';
import 'package:flutter11/ui/features/calculator/state/calculator_store.dart';
import 'package:flutter11/ui/features/motivation/state/motivation_store.dart';
import 'package:flutter11/ui/features/social/state/social_store.dart';
import 'package:flutter11/ui/features/news/state/news_store.dart';

// New Clean Architecture Stores
import 'package:flutter11/ui/features/transactions/state/transactions_list_store.dart';
